...
files = sorted(glob.glob('/mnt/disk/scannet3D/train/*_vh_clean_2.ply'))
files2 = sorted(glob.glob('/mnt/disk/scannet3D/train/*_vh_clean_2.labels.ply'))
...
files = sorted(glob.glob('/mnt/disk/scannet3D/val/*_vh_clean_2.ply'))
files2 = sorted(glob.glob('/mnt/disk/scannet3D/val/*_vh_clean_2.labels.ply'))
assert len(files) == len(files2)
